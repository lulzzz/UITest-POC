...
INSERT [LookUps].[AnnouncementJoinRequestStatus] ([Id], [NameEn], [NameAr]) VALUES (1, N'New', N'تم ارسال طلب الانضمام')
GO
INSERT [LookUps].[AnnouncementJoinRequestStatus] ([Id], [NameEn], [NameAr]) VALUES (2, N'WithDrawn', N'تم سحب الطلب')
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20200511103738_addJoinRequest', N'3.1.0') 
GO
...
update lookups.NotificationOperationCode set DefaultSMS = 1 where NotificationOperationCodeId = 6000 ;
update  [Notification].[UserNotificationSetting] set sms =1  where NotificationCodeId = 6000




update lookups.NotificationOperationCode set DefaultSMS = 1, CanEditSMS = 1 where NotificationOperationCodeId = 6100 ;
update  [Notification].[UserNotificationSetting] set sms =1  where NotificationCodeId = 6100
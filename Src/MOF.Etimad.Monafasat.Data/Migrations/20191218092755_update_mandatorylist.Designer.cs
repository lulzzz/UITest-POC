...
namespace MOF.Etimad.Monafasat.Data.Migrations
{
    ...
    [Migration("20191218092755_update_mandatorylist")]
    partial class update_mandatorylist
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.MandatoryListStatus", b =>
                {
                    ...
                    b.HasData(
                        new { StatusId = 1, NameAr = "تحت الإنشاء" },
                        new { StatusId = 2, NameAr = "بانتظار الاعتماد" },
                        new { StatusId = 3, NameAr = "تم الرفض" },
                        new { StatusId = 4, NameAr = "معتمدة" },
                        new { StatusId = 5, NameAr = "بانتظار اعتماد الإلغاء" },
                        new { StatusId = 6, NameAr = "تم رفض الالغاء" },
                        new { StatusId = 7, NameAr = "تم الالغاء" }
                    );
                });
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.TenderType", b =>
                {
                    ...
                    b.HasData(
                        new { TenderTypeId = 1, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 677, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = " منافسة عامة (جديد)" },
                        new { TenderTypeId = 2, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "شراء مباشر (جديد)" },
                        new { TenderTypeId = 3, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "تأهيل مسبق" },
                        new { TenderTypeId = 4, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "منافسة محدودة" },
                        new { TenderTypeId = 5, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "المزايدة العكسية الإلكترونية" },
                        new { TenderTypeId = 6, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "المنافسة على مرحلتين(المرحلة الاولى)" },
                        new { TenderTypeId = 7, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "المنافسة على مرحلتين(المرحلة الثانية)" },
                        new { TenderTypeId = 8, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "تأهيل لاحق" },
                        new { TenderTypeId = 9, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "منافسة عامة (النظام القديم)" },
                        new { TenderTypeId = 10, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "شراء مباشر (النظام القديم)" },
                        new { TenderTypeId = 11, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "منافسة اتفاقية اطارية" },
                        new { TenderTypeId = 12, BuyingCost = 200.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "مسابقة" },
                        new { TenderTypeId = 13, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 18, 12, 27, 53, 678, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "مشاريع التحول الوطني" }
                    );
                });
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { UserRoleId = 41, DisplayNameAr = "مسؤول منتجات القائمة الإلزامية", DisplayNameEn = "Mandatory List Officer", Name = "LC_ProductsOfficer" },
                        new { UserRoleId = 42, DisplayNameAr = "معتمد منتجات القائمة الإلزامية", DisplayNameEn = "Mandatory List Approver", Name = "LC_ProductsApprover" }
                    );
                });
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.MandatoryListProduct", b =>
                {
                    b.HasOne("MOF.Etimad.Monafasat.Core.Entities.MandatoryList")
                        .WithMany("Products")

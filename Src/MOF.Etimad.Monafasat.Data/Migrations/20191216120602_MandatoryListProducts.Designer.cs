...
namespace MOF.Etimad.Monafasat.Data.Migrations
{
    ...
    [Migration("20191216120602_MandatoryListProducts")]
    partial class MandatoryListProducts
    {
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.MandatoryListStatus", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, NameAr = "تحت الإنشاء" },
                        new { Id = 2, NameAr = "بانتظار الاعتماد" },
                        new { Id = 3, NameAr = "تم الرفض" },
                        new { Id = 4, NameAr = "معتمدة" },
                        new { Id = 5, NameAr = "بانتظار اعتماد الإلغاء" },
                        new { Id = 6, NameAr = "تم رفض الالغاء" },
                        new { Id = 7, NameAr = "تم الالغاء" }
                    );
                });
            ...
            modelBuilder.Entity("MOF.Etimad.Monafasat.Core.Entities.TenderType", b =>
                {
                    ...
                    b.HasData(
                        new { TenderTypeId = 1, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = " منافسة عامة (جديد)" },
                        new { TenderTypeId = 2, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "شراء مباشر (جديد)" },
                        new { TenderTypeId = 3, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "تأهيل مسبق" },
                        new { TenderTypeId = 4, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "منافسة محدودة" },
                        new { TenderTypeId = 5, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "المزايدة العكسية الإلكترونية" },
                        new { TenderTypeId = 6, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "المنافسة على مرحلتين(المرحلة الاولى)" },
                        new { TenderTypeId = 7, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "المنافسة على مرحلتين(المرحلة الثانية)" },
                        new { TenderTypeId = 8, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "تأهيل لاحق" },
                        new { TenderTypeId = 9, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "منافسة عامة (النظام القديم)" },
                        new { TenderTypeId = 10, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "شراء مباشر (النظام القديم)" },
                        new { TenderTypeId = 11, BuyingCost = 500.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "منافسة اتفاقية اطارية" },
                        new { TenderTypeId = 12, BuyingCost = 200.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 200.0m, NameAr = "مسابقة" },
                        new { TenderTypeId = 13, BuyingCost = 0.0m, CreatedAt = new DateTime(2019, 12, 16, 15, 6, 0, 522, DateTimeKind.Local), InvitationCost = 0.0m, NameAr = "مشاريع التحول الوطني" }
                    );
                });

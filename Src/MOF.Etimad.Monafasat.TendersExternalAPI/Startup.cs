...
namespace MOF.Etimad.Monafasat.TendersAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ILocalContentSettingsAppService, LocalContentSettingsAppService>();
            ...
            services.AddScoped<ILocalContentSettingsCommands, LocalContentSettingsCommands>();
            services.AddScoped<ILocalContentSettingsQueries, LocalContentSettingsQueries>();
            #endregion

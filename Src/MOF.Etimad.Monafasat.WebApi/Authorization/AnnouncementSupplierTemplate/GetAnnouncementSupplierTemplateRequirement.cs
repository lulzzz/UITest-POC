...
{
    public class GetAnnouncementSupplierTemplateRequirement : IAuthorizationRequirement { }
    public class GetAnnouncementSupplierTemplateHandler : AuthorizationHandler<GetAnnouncementSupplierTemplateRequirement>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public GetAnnouncementSupplierTemplateHandler(IHttpContextAccessor httpContextAccessor)
        {

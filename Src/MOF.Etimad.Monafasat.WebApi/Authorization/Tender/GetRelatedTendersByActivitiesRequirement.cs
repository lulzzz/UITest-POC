...
{
    public class GetRelatedTendersByActivitiesRequirement : IAuthorizationRequirement { }

    public class GetRelatedTendersByActivitiesHandler : AuthorizationHandler<GetRelatedTendersByActivitiesRequirement>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public GetRelatedTendersByActivitiesHandler(IHttpContextAccessor httpContextAccessor)
        {

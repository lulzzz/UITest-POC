...
{
    public class GetAllAgencyAnnouncementRequirement : IAuthorizationRequirement { }

    public class GetAllAgencyAnnouncementHandler : AuthorizationHandler<GetAllAgencyAnnouncementRequirement>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public GetAllAgencyAnnouncementHandler(IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, GetAllAgencyAnnouncementRequirement requirement)
        {
            ...
            List<string> accessedRoles = new List<string> { RoleNames.MonafasatAdmin, RoleNames.DataEntry
                ,RoleNames.Auditer, RoleNames.OffersOppeningSecretary, RoleNames.OffersOppeningManager, RoleNames.OffersCheckSecretary, RoleNames.OffersCheckManager, RoleNames.MonafasatAccountManager
                , RoleNames.CustomerService, RoleNames.OffersPurchaseSecretary, RoleNames.OffersPurchaseManager, RoleNames.FinancialSupervisor };

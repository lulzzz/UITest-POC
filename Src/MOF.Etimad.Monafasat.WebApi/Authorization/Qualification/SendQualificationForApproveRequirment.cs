...
{
    public class SendQualificationForApproveRequirment : IAuthorizationRequirement
    { }
    public class SendQualificationForApproveHandler : AuthorizationHandler<SendQualificationForApproveRequirment>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public SendQualificationForApproveHandler(IHttpContextAccessor httpContextAccessor)
        {

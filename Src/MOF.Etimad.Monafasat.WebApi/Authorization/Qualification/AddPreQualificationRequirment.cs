...
{
    public class AddPreQualificationRequirment : IAuthorizationRequirement
    { }
    public class AddPreQualificationHandler : AuthorizationHandler<AddPreQualificationRequirment>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public AddPreQualificationHandler(IHttpContextAccessor httpContextAccessor)
        {
            this.httpContextAccessor = httpContextAccessor;
        }
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AddPreQualificationRequirment requirement)
        {

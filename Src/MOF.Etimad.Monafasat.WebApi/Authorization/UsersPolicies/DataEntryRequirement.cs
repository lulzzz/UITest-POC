...
namespace MOF.Etimad.Monafasat.WebApi.Authorization
{
    ...
    public class DataEntryHandler : AuthorizationHandler<DataEntryRequirement>
    {
        ...
        public DataEntryHandler(IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, DataEntryRequirement requirement)
        {
            ...
            List<string> accessedRoles = new List<string> { RoleNames.PurshaseSpecialist, RoleNames.DataEntry, RoleNames.OffersCheckSecretary, RoleNames.OffersPurchaseSecretary };

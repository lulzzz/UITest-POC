...
namespace MOF.Etimad.Monafasat.WebApi.Authorization
{
    ...
    public class OffersCheckSecretaryHandler : AuthorizationHandler<OffersCheckSecretaryRequirement>
    {
        ...
        public OffersCheckSecretaryHandler(IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OffersCheckSecretaryRequirement requirement)
        {
            ...
            List<string> accessedRoles = new List<string> { RoleNames.OffersCheckSecretary, RoleNames.OffersPurchaseSecretary, RoleNames.OffersOpeningAndCheckSecretary, RoleNames.VROOpenAndCheckingViewPolicy, RoleNames.OffersPurchaseManager };

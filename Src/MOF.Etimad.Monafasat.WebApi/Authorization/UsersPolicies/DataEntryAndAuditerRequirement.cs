...
namespace MOF.Etimad.Monafasat.WebApi.Authorization
{
    ...
    public class DataEntryAndAuditerHandler : AuthorizationHandler<DataEntryAndAuditerRequirement>
    {
        ...
        public DataEntryAndAuditerHandler(IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, DataEntryAndAuditerRequirement requirement)
        {
            ...
            List<string> accessedRoles = new List<string> { RoleNames.DataEntry, RoleNames.Auditer, RoleNames.EtimadOfficer, RoleNames.PurshaseSpecialist };

...
{
    public class MonafasatAdminRequirement : IAuthorizationRequirement { }

    public class MonafasatAdminHandler : AuthorizationHandler<MonafasatAdminRequirement>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public MonafasatAdminHandler(IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, MonafasatAdminRequirement requirement)
        {
            ...
            List<string> accessedRoles = new List<string> { RoleNames.MonafasatAdmin };

...
{
    public class AdminAndDataEntryRequirement : IAuthorizationRequirement { }

    public class AdminAndDataEntryHandler : AuthorizationHandler<AdminAndDataEntryRequirement>
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public AdminAndDataEntryHandler(IHttpContextAccessor httpContextAccessor)
        {

...
{
   [ViewComponent(Name = "OfferAttachmentsUpdateForChecking")]
   public class OfferAttachmentsUpdateForCheckingComponent : ViewComponent
   {
      private IApiClient _ApiClient;
      private IMemoryCache _cache;
      //private readonly IConfigurationRoot _configuration;
      private readonly RootConfiguration _rootConfiguration;
      public OfferAttachmentsUpdateForCheckingComponent(IApiClient ApiClient, IMemoryCache cache, IOptionsSnapshot<RootConfiguration> rootConfiguration)
      {

...
namespace MOF.Etimad.Monafasat.Web.ViewComponents.Tender
{
   ...
   [ViewComponent(Name = "OfferAttachmentsDetails")]
   public class OfferAttachmentsDetailsComponent : ViewComponent
   {
      private IApiClient _ApiClient;
      private IMemoryCache _cache;
      //private readonly IConfigurationRoot _configuration;
      private readonly RootConfiguration _rootConfiguration;
      public OfferAttachmentsDetailsComponent(IApiClient ApiClient, IMemoryCache cache, IOptionsSnapshot<RootConfiguration> rootConfiguration)
      {

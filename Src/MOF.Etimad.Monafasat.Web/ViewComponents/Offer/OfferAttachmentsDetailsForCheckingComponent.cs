...
{
   [ViewComponent(Name = "OfferAttachmentsDetailsForCheckingComponent")]
   public class OfferAttachmentsDetailsForCheckingComponent : ViewComponent
   {
      private IApiClient _ApiClient;
      private IMemoryCache _cache;
      //private readonly IConfigurationRoot _configuration;
      private readonly RootConfiguration _rootConfiguration;
      public OfferAttachmentsDetailsForCheckingComponent(IApiClient ApiClient, IMemoryCache cache, IOptionsSnapshot<RootConfiguration> rootConfiguration)
      {
      ...
      public async Task<IViewComponentResult> InvokeAsync(string combinedId)
      {
         try
         {
            ...
            OfferDetailsForCheckingModel model = await _ApiClient.GetAsync<OfferDetailsForCheckingModel>("Offer/GetOfferDetailsForCombinedChecking/" + Util.Decrypt(combinedId), null);

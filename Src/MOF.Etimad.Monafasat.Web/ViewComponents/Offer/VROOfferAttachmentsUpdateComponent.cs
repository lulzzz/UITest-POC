...
{
   [ViewComponent(Name = "VROOfferAttachmentsUpdate")]
   public class VROOfferAttachmentsUpdateComponent : ViewComponent
   {
      private IApiClient _ApiClient;
      private IMemoryCache _cache;
      //private readonly IConfigurationRoot _configuration;
      private RootConfiguration _rootConfiguration;
      public VROOfferAttachmentsUpdateComponent(IApiClient ApiClient, IMemoryCache cache, IOptionsSnapshot<RootConfiguration> rootConfiguration)
      {

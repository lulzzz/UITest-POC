...
namespace MOF.Etimad.Monafasat.Web.ViewComponents.Tender
{
   ...
   [ViewComponent(Name = "VROOfferAttachmentsDetails")]
   public class VROOfferAttachmentsDetailsComponent : ViewComponent
   {
      ...
      public VROOfferAttachmentsDetailsComponent(IApiClient ApiClient, IMemoryCache cache, IOptionsSnapshot<RootConfiguration> rootConfiguration)
      {

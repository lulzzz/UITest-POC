...
{
   [ViewComponent(Name = "QualificationDates")]
   public class QualificationDatesViewComponent : ViewComponent
   {
      private IApiClient _ApiClient;
      public QualificationDatesViewComponent(IApiClient ApiClient)
      {
      ...
      public async Task<IViewComponentResult> InvokeAsync(string tenderIdString)
      {
         ...
         if (tenderModel.ChangeRequestTypeId == (int)Enums.ChangeRequestType.ExtendDates && tenderModel.ChangeRequestStatusId == (int)Enums.ChangeStatusType.Rejected && (User.IsInRole(RoleNames.PreQualificationCommitteeSecretary)))
         {

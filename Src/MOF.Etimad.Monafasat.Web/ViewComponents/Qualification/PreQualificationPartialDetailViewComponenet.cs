...
{
   [ViewComponent(Name = "PreQualificationPartialDetail")]
   public class PreQualificationPartialDetailViewComponenet : ViewComponent
   {
      private IApiClient _ApiClient;
      public PreQualificationPartialDetailViewComponenet(IApiClient ApiClient)
      {

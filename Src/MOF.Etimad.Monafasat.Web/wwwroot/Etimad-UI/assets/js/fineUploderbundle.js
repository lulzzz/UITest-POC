...
qq.UploadHandlerXhr = function (o, uploadCompleteCallback, logCallback) {
   ...
   function handleStandardFileUpload(id) {
      ...
      params.__RequestVerificationToken = $('#' + params.name).closest('form').find('input[name="__RequestVerificationToken"]').val();
...
qq.FineUploaderBasic.prototype = {
   ...
   _formatSize: function (bytes) {
      ...
      return bytes * 1024 + this._options.text.sizeSymbols[1];
...
qq.extend(qq.FineUploader.prototype, {
   ...
   _onSubmit: function (id, name) {
      ...
      //$('body').append('<div id="loader" style="display: none;"><div class="modal-backdrop fade in" style="z-index: 1060;"></div><div style="position: fixed; left: 50%; top: 30%; z-index: 1061;"><div style="position: relative; left: -50%;"><div class="waiting-modal"><img src="/Etimad-UI/assets/imgs/loader.gif" /></div></div></div></div>')
      $('#loader').show();
   },
         ...
         .on('complete', function (event, id, fileName, responseJSON) {
            ...
            if (responseJSON.success) {
               ...
               if ($message.html() == "") {
                  ...
                  $message.find("#" + id).html("<a target='_blank' onclick='resetSessionTimer()'  href='" + fileLink + "' rel='lightbox' alt='عرض الملف' title='عرض الملف' >" + fileName + "</a>").append(deletebtn);
               }
               else {

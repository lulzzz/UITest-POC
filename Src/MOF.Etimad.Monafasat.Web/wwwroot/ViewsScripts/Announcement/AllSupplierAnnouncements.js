...
$(document).ready(function () {
   $('li#menuAllSupplierAnnouncements a').addClass('active');
});
...
var grid = new Vue({
   ...
   data: {
      ...
      currentPage: 1,
      pageSize: 10,
      resource_url: '/Announcement/AllSupplierAnnouncementsPaging',
      queryString: '',
      sort: "SubmitionDate",
      sortDirection: "DESC"
   },
   methods: {
      ...
      search: function () {
         ...
         this.queryString = this.queryString + '&AreasId=' + this.selectedAreaList + '&ActivityId=' + this.selectedActivity + '&SubActivityId=' + this.selectedSubActivity + '&AgencyCode=' + this.selectedAgency
          //  + '&FromLastJoinDateString=' + startDate + '&ToLastJoinDateString=' + endDate
            + '&FromLastJoinDateString=' + $("#hdnfromLastJoinDate").val() + '&ToLastJoinDateString=' + $("#hdntoLastJoinDate").val() + '&TenderTypeId=' + this.selectedTypeList
            + '&AnnouncementPublishDateCriteriaId=' + this.announcementPublishDateCriteriaId + '&AnnouncementActiveStatusId=' + this.announcementActiveStatusId
            + '&SortDirection=' + this.sortDirection + '&Sort=' + this.sort + '&PageSize=' + this.pageSize;
         this.resource_url = '/Announcement/AllSupplierAnnouncementsPaging' + '?' + this.queryString;
      },
      clear: function () {
         ...
         this.queryString = '';
        // this.resource_url = '/Announcement/AllSupplierAnnouncementsPaging';
         $('#tenderName').val('');
         $('#referenceNumber').val('');
         $('#agencyList').val('');
         $('#PublishDate').val('');
       ...
       //  this.announcementActiveStatusId = '';
         $(".selectpicker").selectpicker("refresh");
   ...
   created: function () {
      ...
      document.cookie = "url=/Announcement/AllSupplierAnnouncements" + (_encodedurl == "?undefined" ? "" : _encodedurl) + "";
      this.getAgency();
   },
   updated: function () {
      var _cards = $('#cardsresult');

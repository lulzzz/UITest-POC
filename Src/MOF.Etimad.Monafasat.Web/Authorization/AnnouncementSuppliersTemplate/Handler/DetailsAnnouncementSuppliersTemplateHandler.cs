...
{
   public class DetailsAnnouncementSuppliersTemplateRequirement : IAuthorizationRequirement
   {

   }
   public class DetailsAnnouncementSuppliersTemplateHandler : AuthorizationHandler<DetailsAnnouncementSuppliersTemplateRequirement>
   {
      protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, DetailsAnnouncementSuppliersTemplateRequirement requirement)
      {

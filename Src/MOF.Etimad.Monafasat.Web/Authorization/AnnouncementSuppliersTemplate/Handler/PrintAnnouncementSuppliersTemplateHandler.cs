...
{
   public class PrintAnnouncementSuppliersTemplateRequirement : IAuthorizationRequirement
   {

   }
   public class PrintAnnouncementSuppliersTemplateHandler : AuthorizationHandler<PrintAnnouncementSuppliersTemplateRequirement>
   {
      protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, PrintAnnouncementSuppliersTemplateRequirement requirement)
      {

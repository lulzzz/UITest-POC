...
namespace MOF.Etimad.SharedKernel
{
    public static class Check
    {
        ...
        public static void BusinessRuleProprtyNotNull(object value, string exceptionMessage)
        {
            if (value == null)
            {
        ...
        public static void Validation(bool valid, IEnumerable<ValidationResult> validationResult, string exceptionMessage)
        {
            if (!valid)
            {
                throw new Etimad.Monafasat.SharedKernel.Exceptions.ValidationException(exceptionMessage, validationResult);
            }
        }
